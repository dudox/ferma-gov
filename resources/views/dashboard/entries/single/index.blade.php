                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                    <div class="symbol-label img-fluid avatar img-thumbnail" style="background: url({{ asset('dash/img/default-avatar.png') }}) no-repeat; background-size: cover;"></div>
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                ...
                                <div class="card-body pt-2">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center mb-10">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-30 symbol-light-danger symbol-2by3 flex-shrink-0 mr-4">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary  small">{{ ucfirst($item->roads->name) }}</a>
                                            <span class="text-muted font-weight-bold  my-1 small">Last reporred <span class="text-primary">{{ $item->first()->created_at->diffForHumans() }}</span> </span>
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Info-->
                                        <div class="d-flex align-items-center py-lg-0 py-2">
                                            <div class="d-flex flex-column text-right">
                                                <span class="text-dark-75 font-weight-bolder"><span class=" badge badge-primary">{{ $item->total }}</span></span>
                                                <span class="text-muted font-size-sm font-weight-bolder">Times reported</span>
                                            </div>
                                        </div>
                                        <!--end::Info-->
                                    </div>
