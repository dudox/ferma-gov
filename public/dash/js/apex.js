...
var KTWidgets = function() {
    ...
    return {
        init: function() {
            ...
            function() {
            ...
            }(), t("kt_advance_table_widget_1"), t("kt_advance_table_widget_2"), t("kt_advance_table_widget_3"), t("kt_advance_table_widget_4"), (e = KTUtil.getById("kt_forms_widget_1_input")) && autosize(e), KTUtil.getById("kt_forms_widget_2_form") && new Quill("#kt_forms_widget_2_editor", {
                    modules: {
                        toolbar: {
                ...
                function() {
                    ...
                    t && autosize(t)
                }(), o = KTUtil.getById("kt_app_education_more_feeds_btn"), KTUtil.addEvent(o, "click", function(t) {
                    var e = document.getElementsByClassName("education-more-feeds");
                    !e || e.length <= 0 || (KTUtil.btnWait(o, "spinner spinner-right spinner-white pr-15", "Please wait...", !0), setTimeout(function() {
                        var t;
                        KTUtil.btnRelease(o), KTUtil.addClass(o, "d-none");
                        for (var s = 0, a = e.length; s < a; s++) {
                            t = e[0], KTUtil.removeClass(e[s], "d-none");
